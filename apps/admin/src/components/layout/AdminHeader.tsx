export function AdminHeader() {
  return (
    <header className="h-16 flex items-center justify-between px-6 border-b border-neutral-800 bg-neutral-900/80 backdrop-blur-sm flex-shrink-0">
      <div className="flex items-center gap-3">
        ...
        <div className="lg:hidden flex items-center gap-2">
          ...
          <span className="font-black text-white text-sm">NovaStream Admin</span>
        </div>
